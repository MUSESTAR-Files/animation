...
<main>
    <div class="bottomBar">
        ...
        <a class="iconBox hL" class:myActive={isTouch===1} on:pointerdown={()=>isTouch=1} href="/animation">
            <span class="iconfont defIcon">&#xfc2a;</span>
            <p class="iconName">动漫</p>
        </a>
        <a class="iconBox" class:myActive={isTouch===2} on:pointerdown={()=>isTouch=2} href="/movie">
            <span class="iconfont defIcon">&#xfc48;</span>
            <p class="iconName">影视</p>
        </a>
        <a class="iconBox" class:myActive={isTouch===3} on:pointerdown={()=>isTouch=3} href="https://video.musestar.cc/">
