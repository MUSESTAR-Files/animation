...
<main>
    <div class="bottomBar">
        ...
        <a class="iconBox hL" class:myActive={isTouch===1} on:pointerdown={()=>isTouch=1} href="https://www.musestar.top/animation">
            <span class="iconfont defIcon">&#xfc2a;</span>
            <p class="iconName">动漫</p>
        </a>
        <a class="iconBox" class:myActive={isTouch===2} on:pointerdown={()=>isTouch=2} href="https://www.musestar.top/movie">
        ...
        <a class="iconBox" class:myActive={isTouch===4} on:pointerdown={()=>isTouch=4} href="https://www.musestar.top/musestar">
