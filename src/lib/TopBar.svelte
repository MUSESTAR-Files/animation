...
<main>
    ...
    <div class="THeTopBar" class:TheTopBarPC={!isMobile} class:TheTopBarMo={isMobile}>
        ...
        <div class="inTopA inTopFirst hgLtBox">
            <a href="https://www.musestar.top/animation" class="hgLt">缪斯星动漫</a>
        </div>
        <div class="inTopA">
            <a href="https://www.musestar.top/movie">缪斯星影视</a>
        </div>
        <div class="inTopA">
            <a href="http://www.musestars.top/">缪斯星搜索</a>
        </div>
        <div class="inTopA inTopLast">
            <a href="https://www.musestar.top/musestar">缪斯星官方</a>
        </div>
...
<style>
    ...
    @keyframes teShadow {
        from {
            filter: drop-shadow(0 0 10px rgba(46, 159, 227, .0));
            transform: scale(1);
        }
